    ...
    public class SystemLanguageCodeLogic
    {
        ...
        protected virtual void Verify(SystemLanguageCodePoco[] pocos)
        {
            ...
            foreach (SystemLanguageCodePoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(1000, "LanguageID cannot be blank"));
                }
                if (string.IsNullOrEmpty(poco.Name))
                {
                    exceptions.Add(new ValidationException(1001, "Name cannot be blank"));
                }

                if (string.IsNullOrEmpty(poco.NativeName))
                {
                    exceptions.Add(new ValidationException(1002, "Native Name cannot be blank"));
                }
