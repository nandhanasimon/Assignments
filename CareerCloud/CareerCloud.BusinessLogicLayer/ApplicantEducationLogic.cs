...
namespace CareerCloud.BusinessLogicLayer
{
        ...
        BaseLogic<ApplicantEducationPoco>
    {
        public ApplicantEducationLogic(
            IDataRepository<ApplicantEducationPoco> repo)
            : base(repo) { }
        ...
        protected override void Verify(ApplicantEducationPoco[] pocos)
        {
            ...
            foreach(ApplicantEducationPoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(
                        new ValidationException(107, " you did something wrong"));                        
                }
                ...
                {
                    exceptions.Add(
                        new ValidationException(108, "date is wrong"));
                }
                if (poco.CompletionDate < poco.StartDate)
                {
                    exceptions.Add(
                        new ValidationException(109, "completion date error"));
                }
