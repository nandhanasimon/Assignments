...
namespace CareerCloud.gRPC.Services
{
    ...
    {
        public override Task<ApplicantJobApplication> GetApplicantJobApplication(AppJobAppIdRequest request, ServerCallContext context)
        {
        ...
        public override Task<Empty> DeleteApplicantJobApplication(ApplicantJobApplications request, ServerCallContext context)
        {
            ...
            foreach (ApplicantJobApplication proto in request.AppJobAp)
            {
