...
namespace CareerCloud.gRPC.Services
{
    ...
    {
        public override Task<SystemLanguageCode> GetSystemLanguageCode(SystemLangCodeIdRequest request, ServerCallContext context)
        {
        ...
        public override Task<Empty> DeleteSystemLanguageCode(SystemLanguageCodes request, ServerCallContext context)
        {
            ...
            foreach (SystemLanguageCode proto in request.SysLang)
            {
